const STRINGS = {
  ru: {
    ...
    withdraw: "Отозвать обращение", withdrawConfirm: "Отозвать это обращение? Оно останется в истории, но будет помечено как отозванное.", withdrawError: "Не удалось отозвать обращение.",
    statusWithdrawn: "Отозвано", statusResolved: "Исправлено", deleteQuestion: "Точно ли вы хотите удалить?", confirm: "Подтвердить", cancel: "Отменить", deleteError: "Не удалось удалить обращение.", markFixed: "Проблема исправлена", fixedPhotoHint: "Загрузите фото, подтверждающее исправление", fixedNote: "Что было исправлено? (необязательно)", fixedSubmit: "Отправить на проверку ИИ", fixedChecking: "🤖 ИИ проверяет, действительно ли проблема исправлена…", fixedAccepted: "ИИ подтвердил исправление. Проблема убрана с карты.", fixedRejected: "ИИ не смог подтвердить, что проблема исправлена. Она останется на карте.", fixedError: "Не удалось проверить исправление.", statusPendingFix: "Проверка исправления", descriptionRequired: "Добавьте описание проблемы.", aiChecking: "🤖 ИИ проверяет фото и сравнивает его с описанием…", aiChecked: "Фото сопоставлено с описанием.", aiCheckError: "ИИ не смог проверить фото. Проверьте ключ DeepSeek и журнал Render.", detected: "Обнаружено", confidence: "Уверенность", imageTooLarge: "Фото должно быть JPEG, PNG, GIF или WebP и не больше 2,5 МБ.",
  ...
  en: {
    ...
    withdraw: "Withdraw report", withdrawConfirm: "Withdraw this report? It will remain in history but be marked as withdrawn.", withdrawError: "Could not withdraw the report.",
    statusWithdrawn: "Withdrawn", statusResolved: "Fixed", deleteQuestion: "Are you sure you want to delete it?", confirm: "Confirm", cancel: "Cancel", deleteError: "Could not delete the report.", markFixed: "Problem fixed", fixedPhotoHint: "Upload a photo showing that the problem was fixed", fixedNote: "What was fixed? (optional)", fixedSubmit: "Send for AI review", fixedChecking: "🤖 AI is checking whether the problem was actually fixed…", fixedAccepted: "AI confirmed the fix. The problem was removed from the map.", fixedRejected: "AI could not confirm that the problem was fixed. It will stay on the map.", fixedError: "Could not verify the fix.", statusPendingFix: "Fix under review", descriptionRequired: "Add a description of the problem.", aiChecking: "🤖 AI is checking the photo against the description…", aiChecked: "Photo checked against the description.", aiCheckError: "AI could not check the photo. Check the DeepSeek key and Render logs.", detected: "Detected", confidence: "Confidence", imageTooLarge: "Photo must be JPEG, PNG, GIF or WebP and no larger than 2.5 MB.",
